...
function drawCard(event) {
    ...
    if (faceValue === 1)
    {
        description = `Ace of ${suit}`
        $("p#drawCardOutput").text(description)
    }
    else if (faceValue >= 2)
    {
        description = `${faceValue} of ${suit}`
        $("p#drawCardOutput").text(description)
    }
    ...
    {
        description = `Jack of ${suit}`
        $("p#drawCardOutput").text(description)
    }
    else if (faceValue === 12)
    {
        description = `Queen of ${suit}`
        $("p#drawCardOutput").text(description)
    }
    else if (faceValue === 13)
    {
        description = `King of ${suit}`
        $("p#drawCardOutput").text(description)
    }
    ...
    if (suit === 1)
    {
        description = `${faceValue} of Clubs`
        $("p#drawCardOutput").text(description)
    }
    else if (suit === 2)
    {
        description = `${faceValue} of Spades`
        $("p#drawCardOutput").text(description)
    }
    else if (suit === 3)
    {
        description = `${faceValue} of Hearts`
        $("p#drawCardOutput").text(description)
    }
    else if (suit === 4)
    {
        description = `${faceValue} of Diamonds`
        $("p#drawCardOutput").text(description)
    }
